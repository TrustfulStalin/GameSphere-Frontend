...
const FightGameCreateForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://backgame-c41e5170a8e2.herokuapp.com/fighters', {
        method: 'POST',
        headers: {
  ...
  return (
    <>
    <Header/>
      <h1 className='title'>Please add another fighter</h1>
...
export default FightGameCreateForm;