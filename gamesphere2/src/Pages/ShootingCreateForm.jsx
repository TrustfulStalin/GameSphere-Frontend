...
const ShootingCreate = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://backgame-c41e5170a8e2.herokuapp.com/shooters', {
        method: 'POST',
        headers: {
  ...
  return (
    <>
    <Header/>
      <h1 className='title'>Please add another shooter game</h1>
